...
const testimonials = [
  {
    id: 1,
    text: "As a consulting firm, we needed a partner that could respond fast without disrupting our delivery. iRES gave us calm guidance, quick action, and the confidence to keep moving forward.",
    author: "Kola Asanike",
    role: "Lead Consultant",
    company: "Scrum & Associates Ltd",
    avatar: "/images/person.png",
  },
  {
    id: 2,
    text: "In a fast-moving media environment, downtime can affect reputation and operations. iRES helped us restore our systems quickly and gave our team confidence that our platforms were in safe hands.",
    author: "Jibril Ibrahim",
    role: "CEO",
    company: "i-Media TV",
    avatar: "/images/person.png",
  },
  {
    id: 3,
    text: "For a business advisory practice, we needed security support that was both strategic and practical. iRES delivered with clear communication, rapid response, and real peace of mind.",
    author: "Hafiz Salisu",
    role: "Business Advisory Lead",
    company: "Panoramic Synergy Enterprises",
    avatar: "/images/person.png",
  },
  {
    id: 4,
    text: "As a digital business, we needed a recovery partner that understood both technology and business impact. iRES brought clarity to the situation and helped us get back on track efficiently.",
  ...
  {
    id: 5,
    text: "We valued the professionalism, technical depth, and follow-through from iRES after the incident. Their support felt hands-on, dependable, and completely aligned with our needs as a technology-driven team.",
    author: "Usman Badamasi",
    role: "Lead Consultant",
