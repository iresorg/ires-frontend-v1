  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden flex items-center justify-center px-4 py-6 sm:px-6 sm:py-8">
      ...
      >
        ...
        {/* Signup Form */}
        <form className="space-y-2 sm:space-y-3 text-xs sm:text-sm" onSubmit={handleSubmit(onSubmit)}>
          {/* Company Details */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3">
            <div>
              <input
                ...
                className="w-full bg-gray-700/40 text-gray-200 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base"
              />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3 mt-2 sm:mt-3">
            <div className="flex items-center bg-gray-700/40 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 gap-2">
              <Image
              ...
              <input
                ...
                {...register("email")}
                className="bg-transparent w-full text-gray-500 outline-none text-sm sm:text-base"
              />
            </div>
            {errors.email && (
              <p className="text-red-500 text-[10px] mt-1 md:col-span-2">{errors.email.message}</p>
            )}
            {/* Telephone Input */}
            <div className="relative">
              <div className="flex items-center bg-white/10 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5">
                <div
                ...
                >
                  <Image
                    ...
                    width={20}
                    height={14}
                    className="rounded-sm w-4 h-3 sm:w-5 sm:h-3.5"
                  />
                  <Image
                    ...
                    width={16}
                    height={16}
                    className={`transition-transform w-3.5 h-3.5 sm:w-4 sm:h-4 ${companyCountryDropdownOpen ? "rotate-180" : "rotate-0"}`}
                  />
                </div>
                <input
                  type="tel"
          ...
          <div>
            <label
              ...
              className="block text-gray-500 text-[11px] sm:text-[12px] mt-2 mb-2"
            >
              Company Location
            </label>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-3">
              ...
              <div className="md:col-span-3">
                <input
                  ...
                  className="w-full mt-2 sm:mt-3 bg-gray-700/40 text-gray-200 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base"
                />
          ...
          <div>
            <div>
              <label className="block text-gray-500 text-[11px] sm:text-sm mt-2 mb-2">
                Primary Contact Person
              </label>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-3 md:gap-4">
              <div>
                <input
                  ...
                  className="w-full bg-gray-700/40 text-gray-500 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base"
                />
              ...
              <input
                type="text"
                  ...
                  className="bg-gray-700/40 w-full text-gray-500 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base"
              />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3 md:gap-4 mt-2 sm:mt-3">
              <div>
                <input
                  type="email"
                  placeholder="Email |"
                ...
                <div className="flex items-center bg-white/10 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5">
                  ...
                  >
                    ...
                    <Image
                      ...
                      width={16}
                      height={16}
                      className={`transition-transform w-3.5 h-3.5 sm:w-4 sm:h-4 ${primaryContactCountryDropdownOpen ? "rotate-180" : "rotate-0"}`}
                    />
                  </div>
                  <input
                    type="tel"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mt-3">
            ...
            >
              <div className="flex flex-col items-center">
                ...
                />
                <label htmlFor="dropzone-file" className="space-y-2 sm:space-y-3 mt-2">
                  {fileName ? (
                    ...
                    <p className="text-xs sm:text-sm text-center px-2">
                      <span className="font-semibold italic underline decoration-blue-500 decoration-2 sm:decoration-4 cursor-pointer">
                        Click to upload
                      </span>{" "}
                      or drag and drop{" "}
                    </p>
            ...
            <div className="flex flex-col items-center space-y-2 sm:space-y-3">
              ...
              <div className="w-full">
                <div className="flex items-center bg-white/10 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 gap-2 sm:gap-3">
                  <Image
              ...
              <p className="text-[8px] sm:text-[9px] md:text-[10px] text-gray-500 text-center leading-snug px-2">
